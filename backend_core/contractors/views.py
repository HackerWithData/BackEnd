...
def display_contractor(request, contractor_id):
    ...
    if overview:
        ...
        overview = _("""{lic_name} is a contractor company located in {csp} . 
    ...
    The License is verified as active when we checked last time. If you would like to know {lic_name} more, 
    please contact us and we will share more information and data about this contractor to you.
    """).format(lic_name=contractor.lic_name, csp=contractor.csp, data_source=data_source, score=hscore.score,
                rank=letter_grade,
