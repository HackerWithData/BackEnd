    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lic_type', models.CharField(blank=True, max_length=1000, null=True)),
                ('lic_name', models.CharField(blank=True, max_length=255, null=True)),
                ('lic_status', models.CharField(blank=True, max_length=30, null=True)),
                ('lic_issue_date', models.DateField(null=True)),
                ('lic_expire_date', models.DateField(null=True)),
                ('entity', models.CharField(blank=True, max_length=25, null=True)),
                ('street_address', models.CharField(blank=True, max_length=255, null=True)),
                ('csp', models.CharField(blank=True, max_length=63, null=True)),
                ('state', models.CharField(blank=True, max_length=63, null=True)),
                ('pos_code', models.CharField(blank=True, max_length=25, null=True)),
                ...
                ('license_board', models.CharField(blank=True, default='California Contractor State License Board', max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
