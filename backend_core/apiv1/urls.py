...
urlpatterns = [
    ...
    url(r'^architects/(?P<object_id>[0-9]+)/review/$', ReviewDetail.as_view(), name='review_rest_api'),
    url(r'^architects/(?P<object_id>[0-9]+)/overview/$', OverviewDetail.as_view(), name='overview_rest_api'),
]
